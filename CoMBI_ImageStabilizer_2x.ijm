...
Macro runs Image Stabilizer both forward and backward automatically.
1. Select a folder containing serial image.
2. Run plugin; Image Registration. From first to last image (Forward).
3. Save images and log, and end macro.
4. Run plugin; Image Registration. From last to first image (Backward).
5. Save images and log, and end macro.
6. Save work log.
